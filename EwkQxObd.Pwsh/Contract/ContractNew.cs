...
namespace EwkQxObd.Pwsh.Contract
{
    ...
    public class ContractNew : Cmdlet
    {
        ...
        public EqoAccount? SoldToParty { get; set; }

        [Parameter(Mandatory = true, Position = 3)]
        public EqoContactInfo? Contact { get; set; }

        [Parameter(Mandatory = true, Position = 4)]
        public EqoContactInfo? EmployeResponsible { get; set; }
